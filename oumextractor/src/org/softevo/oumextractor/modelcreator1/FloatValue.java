...
/**
 * This class is used to represent float values.
 *
 * @author Andrzej Wasylkowski
 */
final class FloatValue extends AValue {

    /**
     * The one and only instance of a float value.
     */
    private static FloatValue INSTANCE = new FloatValue();

    /**
     * Creates new representation of any float value.
     */
    private FloatValue() {
    ...
    /**
     * Returns the one and only instance of a float value.
     *
     * @return The one and only instance of a float value.
     */
     ...
     */
    @Override
    public FloatValue clone(ClonesCache clones) throws CloneNotSupportedException {
        if (clones.get(this) == null) {
            FloatValue result = INSTANCE;
            clones.put(this, result);
        }
        return (FloatValue) clones.get(this);
    }
     ...
     */
    @Override
    public FloatValue updateStructure() {
        return this;
    }
